export const en = {
  ...
  diagnostics: { management: "Management sequence/error", usbDrops: "USB input drops", hostDrops: "Host report drops", audioDrops: "Audio queue drops", codecErrors: "Codec errors" },
  validation: {
