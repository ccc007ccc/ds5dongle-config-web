export const zh = {
  ...
  status: {
    ...
    applying: "正在应用配置", saving: "正在保存到 Flash", reconnecting: "正在重连 USB", ready: "等待连接",
  ...
  actions: {
    ...
    reconnectRequired: "此修改需要 USB 重连后生效。", reset: "发布默认值", resetTitle: "应用并保存 M61 发布默认值", state: "状态",
  },
